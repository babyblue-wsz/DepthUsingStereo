...
if __name__ == '__main__':
    ...
    string = 're'
    # 读取数据集的图片
    iml = cv2.imread('./p/bottom/bottom_%d.jpg' % i)  # 左图
    imr = cv2.imread('./p/top/top_%d.jpg' % i)  # 右图
    ...
    cv2.imwrite('./p/results/%sExam%d.png' % (string, i), line)
    ...
    cv2.imwrite('./p/results/%sDisparity%d.png' % (string, i), disp)
